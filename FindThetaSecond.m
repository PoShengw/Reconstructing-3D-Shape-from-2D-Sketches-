...
%         
%           if slope==0
%             if (Edg(Old_ST_Con(i,1),1)-Edg(Old_ST_Con(i,2),1)) >0
%                 theta(i)=0;
%             else
%                 theta(i)=180;
%             end
...
%         
%         if slope>0;
%             if (Edg(Old_ST_Con(i,1),2)-Edg(Old_ST_Con(i,2),2)) > 0 
%                 global_theta(i)=global_theta(i);
%             else
%                 global_theta(i)=global_theta(i)+180;
%             end
%         end
...
%         
%         
%        if global_theta(i)>350 && global_theta(i)<360 || global_theta(i)>0 && global_theta(i)<10
%            global_theta(i)=0;
%        end
%        if global_theta(i)>180 && global_theta(i)<190 || global_theta(i)>170 && global_theta(i)<180
%            global_theta(i)= 180;
%        end
%          
%          
